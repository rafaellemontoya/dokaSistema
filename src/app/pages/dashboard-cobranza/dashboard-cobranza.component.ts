...
@Component({
  selector: 'app-dashboard-cobranza',
  templateUrl: './dashboard-cobranza.component.html',
  styleUrls: ['./dashboard-cobranza.component.css']
})
export class DashboardCobranzaComponent implements OnInit {
